...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    -- JSON schemas for common config files
  ...
  },
  {
    ...
    config = function()
      ...
      -- Override the default LSP floating window function
      ...
      local servers = {
        ...
        -- angularls disabled - incompatible with Angular 5
        -- angularls = {
        ...
        html = {},
        cssls = {},
        jsonls = { -- JSON language server for package.json, angular.json, ionic.config.json
          settings = {
            json = {
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettierd', -- Used to format TypeScript, JavaScript, HTML, CSS, SCSS
        'prettier', -- Fallback formatter
        'eslint_d', -- Used to lint TypeScript and JavaScript
        'angular-language-server', -- Angular language server
        'jdtls', -- Java language server
        'java-debug-adapter', -- Java debugger (optional)
        'java-test', -- Java test runner (optional)
      })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'css', 'scss', 'typescript', 'tsx', 'javascript', 'json', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'yaml', 'go', 'java' },
